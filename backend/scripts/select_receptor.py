...
# The single canonical additive/cryoprotectant/cofactor blacklist — every
# other module that needs to judge "is this HETATM group a real ligand"
# (docking/receptor_prep.py, scripts/panel_candidates.py) imports THIS one,
# rather than keeping its own copy that can drift out of sync.
ADDITIVE_BLACKLIST = {
    "HOH", "WAT", "SO4", "PO4", "GOL", "EDO", "PEG", "ACT", "NA", "CL", "K",
    "MG", "ZN", "CA", "MN", "DMS", "TRS", "FMT", "IOD", "PG4", "1PE", "P6G",
    "BME", "MPD", "IPA", "EOH", "TAR", "CIT", "FLC", "BOG", "LDA", "OLA", "MYR",
    "PLM", "PLP", "FAD", "FMN", "NAD", "NAP", "NDP", "GDP", "GTP", "ADP",
    "ATP", "AMP", "SAH", "SAM", "HEM", "HEC", "COA", "UNL", "UNX", "UNK",
    "SIN", "MES", "HEPES", "EPE", "IMD", "NH4", "CO", "NI", "CD", "CU", "FE",
    "FE2", "BR", "F", "GSH", "SCN", "AZI", "PGE", "PG5", "PG6", "1PG", "15P",
    "2PE", "7PE", "PGO", "MRD", "PEG", "SR", "CS", "RB", "LI", "BA", "CO3",
    "NO3", "OXL", "ACY", "PGA",
    # heavy-atom derivatives soaked in purely for experimental phasing
    # (SAD/MAD) — never a real ligand, but not size/formula-obvious the way
    # a buffer is; confirmed needed by an audit finding GENE_STAT1's
    # registered "ligand" was AU (elemental gold ion).
    "AU", "HG", "PT", "OS", "IR", "PB",
...
# Below this (Da, heavy-atoms-only estimate), a bound HETATM group is almost
# always a cryoprotectant/buffer fragment rather than a real inhibitor —
# same canonical-constant treatment as ADDITIVE_BLACKLIST above.
MIN_LIGAND_MW = 180.0
